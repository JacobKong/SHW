...
//           XWRefreshHeaderStateIdleText = "下拉可以刷新"
//           XWRefreshHeaderStatePullingText = "松开立即刷新"
//           XWRefreshHeaderStateRefreshingText = "正在刷新数据中..."
    ...
    override var lastUpdatedateKey:String{
        didSet{
            if let lastUpdatedTimeDate: AnyObject = NSUserDefaults.standardUserDefaults().objectForKey(lastUpdatedateKey) {
