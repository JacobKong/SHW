...
public extension UIScrollView {
    ...
    var reloadDataClosureClass:xwReloadDataClosureInClass {
        set{
           ...
           objc_setAssociatedObject(self, &XWRefreshReloadDataClosureKey, newValue,objc_AssociationPolicy(OBJC_ASSOCIATION_RETAIN))
           // objc_setAssociatedObject(<#object: AnyObject!#>, <#key: UnsafePointer<Void>#>, <#value: AnyObject!#>, policy: objc_AssociationPolicy)
            self.didChangeValueForKey("reloadDataClosure")
        }
        get{
            if let realClosure: AnyObject = objc_getAssociatedObject(self, &XWRefreshReloadDataClosureKey) {
    ...
    var headerView:XWRefreshHeader?{
        ...
        get{
            if let tmp: AnyObject = objc_getAssociatedObject(self, &XWRefreshHeaderKey){
    ...
    var footerView:XWRefreshFooter?{
        ...
        get{
            if let tmp: AnyObject = objc_getAssociatedObject(self, &XWRefreshFooterKey){
