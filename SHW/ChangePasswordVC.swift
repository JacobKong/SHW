...
class ChangePasswordVC: UIViewController,UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        var  image1 = UIImageView(frame:CGRectMake(CGFloat(15), CGFloat(76+i*60), CGFloat(34), CGFloat(34)))
            image1.image = UIImage(named:image[i])
        var label1 = UILabel(frame: CGRectMake((CGFloat(52), CGFloat(76+i*60),CGFloat(90), CGFloat(34))))
